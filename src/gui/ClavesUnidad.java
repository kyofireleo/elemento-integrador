 ...
 * @author esque
 */
public class ClavesUnidad extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tablaClaves.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Clave SAT", "Descripcion", "Simbolo"
            }
        ) {
        ...
        if (tablaClaves.getColumnModel().getColumnCount() > 0) {
            ...
            tablaClaves.getColumnModel().getColumn(1).setPreferredWidth(100);
            tablaClaves.getColumnModel().getColumn(2).setResizable(false);
            tablaClaves.getColumnModel().getColumn(2).setPreferredWidth(600);
            tablaClaves.getColumnModel().getColumn(3).setResizable(false);
            tablaClaves.getColumnModel().getColumn(3).setPreferredWidth(100);
        }
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(buscarClave, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(10, 10, 10)
                        .addComponent(jLabel1)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(textoBuscar, javax.swing.GroupLayout.PREFERRED_SIZE, 314, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void textoBuscarKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textoBuscarKeyTyped
        ...
        model = (DefaultTableModel) tablaClaves.getModel();
        model.setRowCount(0);
        String clave_sat,desc,sim;
        Integer id;
        System.out.println(text);
        if(text.length() >= 3){
            try {
                rs = stmt.executeQuery("SELECT * FROM c_claveunidad WHERE nombre like '%"+text+"%' order by nombre");
                while(rs.next()){
                    id = rs.getInt("c_claveunidad_id");
                    clave_sat = rs.getString("claveunidad");
                    desc = rs.getString("nombre");
                    sim = rs.getString("simbolo");
                    
                    Object row [] = {id,clave_sat,desc,sim};
                    model.addRow(row);
                }
    ...
    private void buscarPorClave(){
        ...
        ResultSet rs;
        int id;
        String clave_sat, desc, simbolo;
        model = (DefaultTableModel) tablaClaves.getModel();
        model.setRowCount(0);

        try {
            rs = stmt.executeQuery("SELECT * FROM c_claveunidad WHERE claveunidad = '" + claveBuscar.getText().trim() + "'");
            if(rs.next()){
                id = rs.getInt("c_claveunidad_id");
                clave_sat = rs.getString("claveunidad");
                desc = rs.getString("nombre");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClavesUnidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClavesUnidad().setVisible(true);
            }
        });
    }
